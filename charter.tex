...
\begin{itemize}
  \item \textbf{\'{E}pica 1 --- Perfilado de usuarios}
    \begin{itemize}
      ...
      \item \textbf{HU2} (Prioridad: Media, 5 SP): Como responsable del proyecto, quiero enriquecer el perfil RFM con atributos de comportamiento adicionales (categorías más frecuentes, recencia por categoría) para mejorar la calidad de la segmentación.
    \end{itemize}
  ...
  \item \textbf{\'{E}pica 3 --- Transfer learning entre modelos}
    \begin{itemize}
      \item \textbf{HU5} (Prioridad: Alta, 13 SP): Como responsable del proyecto, quiero entrenar un modelo ``pre entrenado'' sobre el dataset Amazon Reviews'23 para contar con una base amplia de productos y perfiles de usuario.
  ...
  \item \textbf{\'{E}pica 4 --- Exposición vía API y prueba de concepto}
    \begin{itemize}
      ...
      \item \textbf{HU8} (Prioridad: Media, 8 SP): Como usuario final, quiero recibir recomendaciones de productos dentro de una conversación de compra simulada (PoC con API de Claude) para validar que el sistema funciona de punta a punta.
    \end{itemize}
\end{itemize}
